 ...
 * @author dioxo
 */
public class FenetreDepar extends javax.swing.JFrame {

    /**
     * Creates new form FenetreDepar
     */
    public FenetreDepar() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FenetreDepar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FenetreDepar().setVisible(true);
            }
        });
    }
